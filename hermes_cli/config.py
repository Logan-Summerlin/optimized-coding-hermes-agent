...
DEFAULT_CONFIG = {
    ...
    "browser": {
        ...
        # Browser supervisor settings are retained for config compatibility.
    ...
    # Hook event schema examples live with the hook command help.
    "hooks": {},
...
def _normalize_custom_provider_entry(
    ...
    *,
    ...
    # Azure Foundry configs). Normalize it up front so the
