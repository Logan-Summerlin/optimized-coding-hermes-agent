...
TOOLSETS = {
    ...
    # Coding posture. Auto-selected in a code workspace; see
    # agent/coding_context.py. Keeps the lean coding + research tools.
    "coding": {
        "description": "Coding-focused toolset: files, terminal, search, web docs, skills, todo",
        "tools": [
            "web_search", "web_extract",
            "terminal", "process",
            "read_file", "write_file", "patch", "search_files",
    ...
    #
    # The CLI and the Telegram gateway share the same lean core tools.
    # ==========================================================================

    "hermes-cli": {
        "description": "Interactive CLI toolset - the lean coding + research core tools",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },

    "hermes-telegram": {
        "description": "Telegram bot toolset - lean coding + research core tools (terminal has safety checks)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },

    "hermes-gateway": {
        "description": "Gateway toolset - Telegram messaging tools",
        "tools": [],
...
if __name__ == "__main__":
    ...
    print("-" * 40)
    combined = resolve_multiple_toolsets(["web", "file", "terminal"])
    print("  Combining ['web', 'file', 'terminal']:")
