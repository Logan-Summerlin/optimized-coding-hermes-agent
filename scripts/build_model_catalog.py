...
Output: ``assets/model-catalog.json`` (the seed shipped in-repo; the model
picker copies it into the disk cache on ``hermes update``).
"""
...
OUTPUT_PATH = os.path.join(REPO_ROOT, "assets", "model-catalog.json")
CATALOG_VERSION = 1
